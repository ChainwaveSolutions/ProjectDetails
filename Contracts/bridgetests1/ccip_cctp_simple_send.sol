...
fee structures as discussed in next meet up , for consideration to have minumum cost to bridge and therefore a minimum token amount to be feasible
...
//manually remove stuck tokens and transfers from this contract back to original source
