...
* Sepolia
*
* test contract 1:  BBBBBB THIS 0xD9b8c3F94B4a7E42ee75595E1AdA15362442c625
*
...
*
* test contract 1:   ***BASE LATEST*** 0x6512D8f04a5B697620f650A012619d4e1EB5a569
*
...
contract ChainWaveBridgeWithStakingTEST is CCIPReceiver, OwnerIsCreator, ReentrancyGuard {
   ...
   function lockAndSend(
        ...
        // Check available pool and adjust balances
        _handleAvailablePool(amountAfterFee);

        // Building the cross-chain message and sending it
    ...
    function _handleAvailablePool(uint256 amountAfterFee) internal {
        ...
        // If necessary, take funds from the staked balances
    ...
    function _sendCrossChainMessage(
        ...
        Client.EVMTokenAmount; // Empty token amounts array
    ...
    /**
    * @dev Allows the owner or operator to allow or disallow a chain.
    * @param chainSelector The chain selector to allow or disallow.
    ...
    */
    ...
    /**
    * @dev Allows the owner or operator to allow or disallow a destination contract.
    * @param contractAddress The address of the destination contract to allow or disallow.
    ...
    */
    ...
    for (uint256 i = 0; i < stakersCount; i++) {
        ...
        stakedBalances[staker] = stakedBalances[staker] - deduction;
        totalStaked = totalStaked - deduction;

        // Track deduction for future reward distribution
        // Implement logic to handle rewards based on used staked funds
    }
}
